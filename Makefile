...
coverage:
	...
	-n auto \
	$(PACKAGE_NAME)
	pytest --pdb --cov-report term-missing --cov=$(PACKAGE_NAME) --cov-append --verbose ./external/eagerpy_tests
	pytest --pdb --cov-report term-missing --cov=$(PACKAGE_NAME) --cov-append --verbose --backend numpy ./external/eagerpy_tests
