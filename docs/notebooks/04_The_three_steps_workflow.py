...
# + id="a3cdb104" outputId="2a8b84e5-1d90-4c06-bed5-1518bdfdc767" colab={"base_uri": "https://localhost:8080/"}
...
# + tags=["parameters"] id="768d7802-580d-4c31-9a0e-e6dc4f0589ca"
T = 1.0e5
N = 1000

# + tags=[] id="03af743d" outputId="ae3f7e8f-7e2c-4ef1-a456-bd4d2f72893d" colab={"base_uri": "https://localhost:8080/"}
# %%time
T, N = map(int, (T, N))
...
# + tags=[] id="27092faf" outputId="760f16e5-bc4d-4bf1-fa1b-7749e1d2366f" colab={"base_uri": "https://localhost:8080/"}
# %%time
...
# + tags=[] id="11f3705d" outputId="75921f06-a92c-4e1a-a7f9-49866659c232" colab={"base_uri": "https://localhost:8080/"}
# %%time
...
# + tags=[] id="f87f5668" outputId="7e3e0052-803a-48ac-ae9a-c2b68af8c575" colab={"base_uri": "https://localhost:8080/"}
# %%time
df_ewma_wax_no_format = dataframe.wax.ewm(alpha=1.0 / 10.0, format_outputs=False).mean()

# + id="88d0cab5-62ad-47f7-9d06-56fc45fa542e" outputId="41fe33ca-4713-4a9d-a595-5c85696ff76f" colab={"base_uri": "https://localhost:8080/"}
...
# + id="38d3970c-04a5-4deb-93b3-a4f5f899e8f1" outputId="ae302feb-5e16-4a53-8aad-6dd12de7d4e8" colab={"base_uri": "https://localhost:8080/"}
...
# + id="5f6b72ca" outputId="18f8761e-f198-476c-a3e0-06b6773d874a" colab={"base_uri": "https://localhost:8080/"}
# %%time
...
# + id="dc9a4bce-83d1-494b-b053-c6f9ebfb7d0c" outputId="4c4e08a8-5c03-468f-96bb-c0b10fdb1d79" colab={"base_uri": "https://localhost:8080/"}
params
...
# + id="3862a486-a5a2-4aa9-967a-59ebc32a18e1" outputId="bb926b58-cb8e-44df-a38d-56e6fa758466" colab={"base_uri": "https://localhost:8080/"}
outputs.device()

# + [markdown] id="b73f3252"
# Once it has been compiled and "traced" by JAX, the function is much faster to execute:

# + tags=[] id="a889d294" outputId="1bbcad84-5bc0-49d3-865f-685e75892793" colab={"base_uri": "https://localhost:8080/"}
# %%timeit
outputs, _ = dynamic_unroll(transform_dataset, params, state, rng, False, jxs)

# + id="f19185cd-15c2-4c9c-bbff-8d50deb1fee2" outputId="b32b7d89-570d-4b09-ac53-d1119144ee65" colab={"base_uri": "https://localhost:8080/"}
# %%time
outputs, _ = dynamic_unroll(transform_dataset, params, state, rng, False, jxs)
...
# + id="76479f76-7b6e-4321-97c3-942f2987bc01" outputId="c4c46c35-4e93-4f7b-8197-0520f8f0e1e0" colab={"base_uri": "https://localhost:8080/"}
...
# + id="bae591f7-e7ec-4b8b-9b80-6f129184e1ae" outputId="f073bab3-7f7b-4ed6-a5df-5266418d4072" colab={"base_uri": "https://localhost:8080/"}
...
# + id="e7ebbb08-d790-4977-b49d-c9224e299a42" outputId="c91ac27c-b671-4bad-8e0d-c9eb0464ae3c" colab={"base_uri": "https://localhost:8080/"}
# %%time
@jit_init_apply
...
# + id="f851407a-597f-4711-8370-c3e83cb50da7" outputId="585097e9-6025-4f45-886e-261cbdba4014" colab={"base_uri": "https://localhost:8080/"}
# %%time
outputs, state = dynamic_unroll(transform_dataset, None, None, rng, False, jxs)

# + id="e5b786b7-ecaf-4280-894b-aa8f65a0b78f" outputId="c8bc9f41-7587-4482-c496-f40523f6840f" colab={"base_uri": "https://localhost:8080/"}
outputs.device()
...
# + id="d1b0732c" outputId="7427109b-7cfa-455c-af20-080b73b86182" colab={"base_uri": "https://localhost:8080/"}
# %%time
y = format_dataframe(
...
# + id="a30f6024-5e9c-4174-92ea-7207860d829d" outputId="ee0cc84f-e332-485b-fddd-ee5ce42b6ce8" colab={"base_uri": "https://localhost:8080/"}
try:
...
# + id="d6f00e5d-1b85-483d-9856-35de3a954b13" outputId="db9396c3-b35d-4cdc-aaa3-eadddc9da31c" colab={"base_uri": "https://localhost:8080/"}
tree_leaves(jnp_data)[0].device()

# + id="6f89fc7c-4824-4858-aee8-6fff7834c70c" outputId="40c8a645-5771-40f0-ffab-0e5322d59c77" colab={"base_uri": "https://localhost:8080/"}
tree_leaves(jnp_index)[0].device()

# + id="ba2471ef-51e4-49f2-863c-aabafd401cbf" outputId="25800a2f-4152-4714-9ceb-ba396fcf1790" colab={"base_uri": "https://localhost:8080/"}
jxs.device()

# + id="6c35bd5d-0113-455d-bd56-f7c31bf6c736" outputId="86e2ff5d-3b7b-4b65-8202-0feebc27063d" colab={"base_uri": "https://localhost:8080/"}
# %%time
if GPU_AVAILABLE:
    rng = next(hk.PRNGSequence(42))
    outputs, state = dynamic_unroll(transform_dataset, None, None, rng, False, jxs)
...
# + id="6bb7431e-90f2-4761-a906-69f25fea4a63" outputId="405cc724-22e8-48d6-e722-d6cea8a90e49" colab={"base_uri": "https://localhost:8080/"}
# %%time
if GPU_AVAILABLE:
...
# + id="944dcb8e-211c-4b39-b854-12118fe775ed" outputId="d1f353b2-a7ed-4457-a26c-38ac4125aa65" colab={"base_uri": "https://localhost:8080/"}
outputs.device()

# + id="de99ee71-4e02-4843-9e6e-39d831f9697e" outputId="88a5e604-a722-43bf-d90c-49b11fde96b2" colab={"base_uri": "https://localhost:8080/"}
# %%timeit
if GPU_AVAILABLE:
    outputs, state = dynamic_unroll(transform_dataset, None, None, rng, False, jxs)
