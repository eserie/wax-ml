...
class StreamDataFrame(Stream):
    ...
    def apply(
        ...
        if not _has_multi_index(dataframe):
            ...
            dataarray = dataframe.stack(list(range(dataframe.columns.nlevels))).to_xarray()
...
class WaxAccessor:
    def ewm(self, *args, **kwargs):
        return ExponentialMovingWindow(*args, accessor=self, **kwargs)
...
class ExponentialMovingWindow:
    ...
    def mean(self):
        ...
        def _apply_ema(*, accessor, return_state, format_outputs, **kwargs):
            return accessor.stream(return_state=return_state, format_outputs=format_outputs).apply(
...
class WaxDatasetAccessor(WaxAccessor):
    ...
    def stream(self, *args, **kwargs):
        return StreamDataset(*args, accessor=self, **kwargs)
...
class WaxDataArrayAccessor(WaxAccessor):
    ...
    def stream(self, *args, **kwargs):
        return StreamDataArray(*args, accessor=self, **kwargs)
...
class WaxDataFrameAccessor(WaxAccessor):
    ...
    def stream(self, *args, **kwargs):
        return StreamDataFrame(*args, accessor=self, **kwargs)
...
class WaxSeriesAccessor(WaxAccessor):
    ...
    def stream(self, *args, **kwargs):
        return StreamSeries(*args, accessor=self, **kwargs)
